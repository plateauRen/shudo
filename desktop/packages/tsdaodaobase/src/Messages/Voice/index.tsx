            ...
            <div className="wk-message-voice">
                ...
                <div className="wk-message-voice-info">
                    <div className="wk-message-voice-waveform">
                        <WaveCanvas barColor={isSend?"rgba(31, 35, 41, 0.25)":"rgba(0, 0, 0, 0.2)"} waveform={this.waveform ?? []} width={200} height={23} />
                        <div ref={this.lightWavformRef} className="wk-message-voice-lightWavform">
                            <WaveCanvas barColor={WKApp.config.themeColor} waveform={this.waveform ?? []} width={200} height={23} />
                        </div>
                    </div>
