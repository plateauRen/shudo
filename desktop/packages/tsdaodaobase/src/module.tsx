...
export default class BaseModule implements IModule {
  ...
  init(): void {
    ...
    WKApp.messageManager.registerMessageFactor(
      (contentType: number): ElementType | undefined => {
        switch (contentType) {
          ...
          case MessageContentTypeConst.hermesCard:
            return HermesCardCell;
          case MessageContentTypeConst.hermesAction:
    ...
    // HTML / plain text (WYSIWYG composer uses format=html)
    ...
    WKSDK.shared().register(
      MessageContentTypeConst.hermesCard,
      () => new HermesCardContent()
    );
    WKSDK.shared().register(
      MessageContentTypeConst.hermesAction,
      () => new HermesActionContent()
    );
    WKSDK.shared().register(
