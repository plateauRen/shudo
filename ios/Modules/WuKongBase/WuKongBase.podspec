...
TODO: Add long description of the pod here.
  ...
  s.resource_bundles = {
    ...
    'WuKongBase_RichEditor' => ['WuKongBase/Assets/RichEditor']
  }
 ...
 s.resources = ['WuKongBase/Assets/Lang']
  ...
  s.exclude_files = '**/BUILD', '**/BUILD.skip', '**/YuvConversion/BUILD*'
...
#  s.resource  = 'WuKongBase/WuKongIMSDK-Framework/ios/WuKongIMSDK.framework/Versions/A/Resources/WuKongIMSDK.bundle'
  # Bugly 仅含真机 arm64，Apple Silicon 模拟器不链接；WKApp.m 内已用 TARGET_OS_SIMULATOR 包裹
  s.preserve_paths = 'WuKongBase/Bugly.framework'
  s.pod_target_xcconfig = {
    'FRAMEWORK_SEARCH_PATHS[sdk=iphoneos*]' => '$(inherited) "$(PODS_TARGET_SRCROOT)/WuKongBase"',
    'OTHER_LDFLAGS[sdk=iphoneos*]' => '$(inherited) -framework "Bugly"'
  }
