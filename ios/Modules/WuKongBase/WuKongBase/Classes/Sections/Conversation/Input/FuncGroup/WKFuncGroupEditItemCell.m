...
-(void) refresh:(WKFuncGroupEditItemModel *) model {
    self.iconImgView.image = [model.itemIcon imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    self.iconImgView.tintColor = [WKPanelDefaultFuncItem toolbarIconTint];
...
- (UIImageView *)iconImgView {
    if(!_iconImgView) {
        _iconImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 28.0f, 28.0f)];
