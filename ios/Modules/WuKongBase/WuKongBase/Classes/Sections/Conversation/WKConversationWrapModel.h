...
/// Cached attributed last-message preview (invalidated when conversation content changes).
@property(nonatomic,strong,nullable) NSAttributedString *cachedLastContentAttr;
@property(nonatomic,copy,nullable) NSString *cachedLastContentKey;
