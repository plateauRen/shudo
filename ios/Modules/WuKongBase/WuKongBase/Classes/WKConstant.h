...
// 长按菜单 - 查看（气泡详情 / 系统选字复制）
#define WKPOINT_LONGMENUS_VIEW @"longmenus.view"
// 长按菜单 - 删除
...
#define WKPOINT_CATEGORY_PANELFUNCITEM_RICH @"panel.func.item.rich"
// 发送视频
...
typedef enum : NSUInteger {
    ...
    // Hermes 交互卡：见 WuKongIMSDK WKConst.h（WK_HERMES_CARD=21000 / WK_HERMES_ACTION=21001）
