...
/// Brand accent for voice panel chrome (follows WKAppConfig.themeColor).
FOUNDATION_EXPORT UIColor *CWSelectBackgroundColor(void);
#define kSelectBackGroudColor CWSelectBackgroundColor()
