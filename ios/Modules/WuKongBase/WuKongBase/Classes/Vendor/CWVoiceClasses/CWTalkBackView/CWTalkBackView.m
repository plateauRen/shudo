...
- (UIImageView *)voiceLine {
    if (_voiceLine == nil) {
        UIImage *line = [self imageName:@"Conversation/VoiceRecord/aio_voice_line"];
        line = [line imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        UIImageView *imageV = [[UIImageView alloc] initWithImage:line];
        imageV.tintColor = kSelectBackGroudColor;
