...
- (UIButton *)settingBtn {
    if(!_settingBtn) {
        ...
        _settingBtn.lim_top = safeTop + 4.0f;
        _settingBtn.lim_left = self.view.lim_width - _settingBtn.lim_width - 16.0f;
...
- (void)viewDidLayoutSubviews {
    ...
    if (_settingBtn) {
        CGFloat safeTop = self.view.safeAreaInsets.top;
        if (safeTop < 44.0f) { safeTop = 47.0f; }
        _settingBtn.frame = CGRectMake(self.view.bounds.size.width - 44.0f - 16.0f, safeTop + 4.0f, 44.0f, 44.0f);
